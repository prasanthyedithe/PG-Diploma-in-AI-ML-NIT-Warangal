...
def fetch_rss_feed(url_value):
    try:
        ...
        raise Exception("Sorry, Error while Feedparser", e)
...
def news_feed(url_value):
    ...
    try:
        ...
        raise Exception("Sorry, Error while Printing All Feeds", e)
...
def news_feed_limit(url_value, limit_value):
    ...
    try:
        ...
        raise Exception("Sorry, Error while Printing Range Feeds", e)
...
def save_news_feed_json(url_value, limit_value):
    ...
    try:
        ...
        raise Exception("Sorry, Error while Saving Feeds in JSON formate", e)
...
def fetch_news_feed_date_limit(date_value, limit_value):
    ...
    try:
        ...
        raise Exception("Sorry, Error while Fetching Feeds based on Date and Limit", e)
...
def fetch_news_feed_json_limit_date(limit_value, date_value):
    ...
    try:
        ...
        raise Exception("Sorry, Error while Fetching Feeds based on Date and Limit in JSON formate", e)
...
def save_news_feed_to_pdf(url_value, limit_value):
    ...
    try:
        ...
        raise Exception("Sorry, Error while Saving Feeds to PDF", e)
...
def save_news_feed_to_html(url_value, limit_value):
    ...
    try:
        ...
        raise Exception("Sorry, Error while Saving Feeds to HTML", e)
